...
class GespeicherteArtikel extends StatefulWidget {
  @override
  _GespeicherteArtikelState createState() => _GespeicherteArtikelState();
}

class _GespeicherteArtikelState extends State<GespeicherteArtikel> {
  @override
